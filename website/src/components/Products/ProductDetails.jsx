...
const ProductDetails = ({ data }) => {
  ...
  useEffect(() => {
    // Sirf jab seller._id change ho tab hi API call karo
    if (data?.seller?._id) {
      dispatch(getAllProductsShop(data.seller._id));
    }
  }, [data?.seller?._id, dispatch]); // Sirf seller ID ko track karo

  useEffect(() => {
    // Wishlist logic ko alag useEffect mein rakho
            ...
            <div className="block w-full min-[800px]:flex">
              ...
              <div className="w-full min-[800px]:w-[50%] pt-5">
                ...
                <div className="flex items-center pt-8">
                  ...
                  >
                    <span className="text-white flex items-center">
                      Send Message kro yll <AiOutlineMessage className="ml-1" />
                    </span>
                  </div>
                </div>
              </div>
    ...
    <div className="bg-[#f5f6fb] px-3 800px:px-10 py-2 rounded">
      ...
      {active === 3 && (
        <div className="w-full block 800px:flex p-5">
          <div className="w-full min-[800px]:w-[50%]">
            <Link to={`/shop/preview/${data.shop._id}`}>
              <div className="flex items-center">
                <img src="" className="w-[50px] h-[50px] rounded-full" alt="" />
                <div className="pl-3">
          ...
          <div className="w-full min-[800px]:w-[50%] mt-5 800px:mt-0 min-[800px]:flex flex-col items-end">
