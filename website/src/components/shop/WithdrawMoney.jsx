...
import { getAllOrdersOfShop } from "../../redux/order/orderSlice";
...
const WithdrawMoney = () => {
  ...
  useEffect(() => {
    dispatch(getAllOrdersOfShop(seller?.userId._id));
  }, [dispatch]);
  ...
  const handleSubmit = async (e) => {
    ...
    await api
      .put(
        `${server}/seller/update-payment-methods`,
        {
          withdrawMethod,
        },
  ...
  const deleteHandler = async () => {
    await api
      .delete(`${server}/seller/delete-withdraw-method`, {
        withCredentials: true,
      })
      .then((res) => {
            ...
            {paymentMethod ? (
              ...
              <>
                ...
                {seller && seller?.withdrawMethod ? (
                  <div>
                    <div className="min-[800px]:flex w-full justify-between items-center">
                    ...
                    <br />
                    <div className="min-[800px]:flex w-full items-center">
                      <input
                        type="number"
                        placeholder="Amount..."
                        value={withdrawAmount}
                        onChange={(e) => setWithdrawAmount(e.target.value)}
                        className="min-[800px]:w-[100px] w-[full] border 800px:mr-3 p-1 rounded"
                      />
                      <div
